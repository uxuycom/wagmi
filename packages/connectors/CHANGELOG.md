...
- c4d5bb5: **Breaking:** Removed the `version` config option for `WalletConnectConnector`.
  ...
  ```diff
  import { WalletConnectConnector } from '@tg-wagmi/connectors/walletConnect'
  ...
  ```diff
  -import { WalletConnectConnector } from '@tg-wagmi/connectors/walletConnect'
  +import { WalletConnectLegacyConnector } from '@tg-wagmi/connectors/walletConnectLegacy'
...
- 55a0ca2: Initial release of the `@tg-wagmi/connectors` package – a collection of Connectors for wagmi.
