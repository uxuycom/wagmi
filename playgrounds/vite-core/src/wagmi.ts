import { coinbaseWallet, metaMask, walletConnect } from '@tg-wagmi/connectors'
import { http, createConfig, createStorage } from '@tg-wagmi/core'
import { mainnet, optimism, sepolia } from '@tg-wagmi/core/chains'
