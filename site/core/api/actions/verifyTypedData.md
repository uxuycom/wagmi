...
```ts
import { verifyTypedData } from '@uxuyalpha/core'
```
...
```ts
import { type VerifyTypedDataParameters } from '@uxuyalpha/core'
```
...
```ts
import { type VerifyTypedDataReturnType } from '@uxuyalpha/core'
```
...
```ts
import { type VerifyTypedDataErrorType } from '@uxuyalpha/core'
```
