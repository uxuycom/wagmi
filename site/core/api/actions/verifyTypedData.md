...
```ts
import { verifyTypedData } from '@tg-wagmi/core'
```
...
```ts
import { type VerifyTypedDataParameters } from '@tg-wagmi/core'
```
...
```ts
import { type VerifyTypedDataReturnType } from '@tg-wagmi/core'
```
...
```ts
import { type VerifyTypedDataErrorType } from '@tg-wagmi/core'
```
