...
```ts
import { call } from '@tg-wagmi/core'
```
...
```ts twoslash
import { type CallParameters } from '@tg-wagmi/core'
```
...
```ts twoslash
import { type CallReturnType } from '@tg-wagmi/core'
```
...
```ts twoslash
import { type CallErrorType } from '@tg-wagmi/core'
```
