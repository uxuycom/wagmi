...
```ts
import { watchBlockNumber } from '@tg-wagmi/core'
```
...
```ts
import { type WatchBlockNumberParameters } from '@tg-wagmi/core'
```
...
```ts
import { type WatchBlockNumberReturnType } from '@tg-wagmi/core'
```
