...
```ts
import { type WatchContractEventParameters } from '@tg-wagmi/core'
```
...
```ts
import { type WatchContractEventReturnType } from '@tg-wagmi/core'
```
...
```ts
import { type WatchContractEventError } from '@tg-wagmi/core'
```
