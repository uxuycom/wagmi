...
```ts
import { estimateGas } from '@tg-wagmi/core'
```
...
```ts
import { type EstimateGasParameters } from '@tg-wagmi/core'
```
...
```ts
import { type EstimateGasReturnType } from '@tg-wagmi/core'
```
...
```ts
import { type EstimateGasErrorType } from '@tg-wagmi/core'
```
