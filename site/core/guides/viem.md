...
// 1. Import modules. 
import { http, createConfig, getClient, getConnectorClient } from '@tg-wagmi/core' 
import { base, mainnet, optimism, zora } from '@tg-wagmi/core/chains' 
...
```tsx [Client Actions]
// 1. Import modules. 
import { http, createConfig, getPublicClient, getWalletClient } from '@tg-wagmi/core' 
import { base, mainnet, optimism, zora } from '@tg-wagmi/core/chains' 
...
```tsx
import { http, createConfig, sendTransaction } from '@tg-wagmi/core' 
import { base, mainnet, optimism, zora } from '@tg-wagmi/core/chains' 
