...
### customStoragePrefix <Badge :text="`${packageName === '@tg-wagmi/core' ? '@tg-wagmi/connectors@>=5.1.8' : `${packageName}@>=${packageName === 'wagmi' ? '2.12.8' : packageName === '@tg-wagmi/vue' ? '0.0.40' : ''}`}`" />
