...
import { base, mainnet, optimism } from '@tg-wagmi/vue/chains'
import { injected, metaMask, safe, walletConnect } from '@tg-wagmi/vue/connectors'
...
```vue [Connect.vue]
<script setup lang="ts">
import { useConnect, useChainId } from '@tg-wagmi/vue';
...
```vue [Account.vue]
<script setup lang="ts">
import { useAccount, useDisconnect } from '@tg-wagmi/vue';
