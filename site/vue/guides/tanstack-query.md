...
import { useBalance } from '@tg-wagmi/vue' // [!code hl]
...
```ts 
import { getBalanceQueryOptions } from '@tg-wagmi/vue/query' // [!code hl]
...
import { useBlockNumber, useBalance } from '@tg-wagmi/vue' 
...
::: code-group
```tsx [example.tsx]
import { getBlockQueryOptions } from '@tg-wagmi/vue/query'
...
::: code-group
```tsx [example.tsx]
import type { GetBalanceReturnType } from '@tg-wagmi/vue/actions'
import { getBalanceQueryOptions } from '@tg-wagmi/vue/query'
...
```vue
<script setup lang="ts">
import { useConfig, useChainId, useQueryClient } from '@tg-wagmi/vue'
import { getBlockQueryOptions } from '@tg-wagmi/vue/query'
